...
# TK-163-FE: Modales a Hoja Completa en Teléfono
...
## Descripción
Aplicar el tramo `xs` (`<480px`) declarado en el sistema de diseño §6 a los modales de las rutas en alcance: que en `xs` se presenten a hoja completa en lugar de ventana centrada, con el botón de confirmación al alcance del pulgar.
...
**Infrastructure (UI):** `ConsumeReasonModal`, `DiscardModal`, `WarehouseExtractionModal`, `RecipeSelectorModal` y sus estilos. Los tokens y el corte de tramo salen del sistema de diseño; **prohibido introducir un ancho de corte ad-hoc** sin declararlo antes en la matriz §6.
