...
5. **Concrete Workspace Context:** Never give generic architectural advice; always cite specific project paths (`docs/` and the source paths declared in `docs/00_stack_manifest.md`).
...
2. No physical database schema, API contract (`OpenAPI`), or domain entities are altered.
3. Existing unit tests continue to pass with 0 regressions (the canonical test command in `docs/00_stack_manifest.md` §7).
