...
inputs:
  ...
  - target_url: "URL base del entorno de pruebas o staging — si no se pasa, se infiere de docs/00_stack_manifest.md §7"
outputs:
...
1. **Definición de Umbrales de Rendimiento (NFR del proyecto antes que default genérico):**
